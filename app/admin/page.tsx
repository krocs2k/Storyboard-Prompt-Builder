...
import { Loader2, Users, Settings, Shield, Github, Database, Key, Image as ImageIcon, BarChart3, Film } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white">Gemini API</h2>
                <p className="text-gray-400 text-sm">Image generation key</p>
              </div>
            </div>
            <p className="text-gray-400 text-sm">Configure Google Gemini / Imagen API key</p>
          </Link>
